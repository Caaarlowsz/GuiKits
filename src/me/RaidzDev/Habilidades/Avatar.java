...
public class Avatar implements Listener {
	...
	public void Trocar(final PlayerInteractEvent e) {
		...
		if ((e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK)
				&& KitAPI.getkit(p) == "Avatar" && p.getItemInHand().getType() == Material.WOOL) {
			p.setItemInHand(AR);
			Avatar.Ferro.add(p.getName());
		} else if (Avatar.Ferro.contains(p.getName())
				&& (e.getAction() == Action.LEFT_CLICK_AIR || e.getAction() == Action.LEFT_CLICK_BLOCK)
				&& KitAPI.getkit(p) == "Avatar" && p.getItemInHand().equals((Object) AR)) {
			p.setItemInHand(Agua);
			Avatar.Ferro.remove(p.getName());
			Avatar.Avatar2.add(p.getName());
		} else if (Avatar.Avatar2.contains(p.getName())
				&& (e.getAction() == Action.LEFT_CLICK_AIR || e.getAction() == Action.LEFT_CLICK_BLOCK)
				&& KitAPI.getkit(p) == "Avatar" && p.getItemInHand().equals((Object) Agua)) {
			p.setItemInHand(Terra);
			Avatar.Avatar2.remove(p.getName());
			Avatar.Terras.add(p.getName());
		} else if (Avatar.Terras.contains(p.getName()) && Avatar.Terras.contains(p.getName())
				&& (e.getAction() == Action.LEFT_CLICK_AIR || e.getAction() == Action.LEFT_CLICK_BLOCK)
				&& KitAPI.getkit(p) == "Avatar" && p.getItemInHand().equals((Object) Terra)) {
			p.setItemInHand(Fogo);
			Avatar.Terras.remove(p.getName());
			Avatar.Red.add(p.getName());
		} else if (Avatar.Red.contains(p.getName())
				&& (e.getAction() == Action.LEFT_CLICK_AIR || e.getAction() == Action.LEFT_CLICK_BLOCK)
				&& KitAPI.getkit(p) == "Avatar" && p.getItemInHand().equals((Object) Fogo)) {
			p.setItemInHand(AR);
	...
	public void AvatarAr(final PlayerInteractEvent event) {
		...
		if (Avatar.Ferro.contains(p.getName())
	...
	public void AvatarAr1(final PlayerInteractEvent event) {
		final Player p = event.getPlayer();
		if (Avatar.Avatar2.contains(p.getName())
				&& (event.getAction() == Action.RIGHT_CLICK_AIR || event.getAction() == Action.RIGHT_CLICK_BLOCK)
				&& KitAPI.getkit(p) == "Avatar" && p.getItemInHand().getType() == Material.LAPIS_BLOCK) {
			event.setCancelled(true);
			if (!Avatar.Tempo.contains(p)) {
				Avatar.Tempo.add(p);
	...
	public void AvatarAr11(final PlayerInteractEvent event) {
		final Player p = event.getPlayer();
		if (Avatar.Red.contains(p.getName())
				&& (event.getAction() == Action.RIGHT_CLICK_AIR || event.getAction() == Action.RIGHT_CLICK_BLOCK)
				&& KitAPI.getkit(p) == "Avatar" && p.getItemInHand().getType() == Material.REDSTONE_BLOCK) {
			event.setCancelled(true);
			if (!Avatar.Tempo.contains(p)) {
				Avatar.Tempo.add(p);
	...
	public void AvatarTerra(final PlayerInteractEvent event) {
		final Player p = event.getPlayer();
		if (Avatar.Terras.contains(p.getName())
				&& (event.getAction() == Action.RIGHT_CLICK_AIR || event.getAction() == Action.RIGHT_CLICK_BLOCK)
				&& KitAPI.getkit(p) == "Avatar" && p.getItemInHand().getType() == Material.GRASS) {
			event.setCancelled(true);
			if (!Avatar.Tempo.contains(p)) {
				Avatar.Tempo.add(p);
