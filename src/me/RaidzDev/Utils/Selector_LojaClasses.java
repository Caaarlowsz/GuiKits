...
public class Selector_LojaClasses implements Listener, CommandExecutor
{
    ...
    public static void money(final Player p) {
        final Inventory inv = Bukkit.getServer().createInventory((InventoryHolder)p, 27, String.valueOf(Config.cor) + "Loja de Classes");
        ...
        zStomper.setLore((List)descpyro);
        ...
        zDeshfire.setLore((List)descpyros);
        ...
        zViking.setLore((List)descpyrosas);
        ...
        zGladiator.setLore((List)descpyrosea);
    ...
    public void click(final InventoryClickEvent e) {
        ...
        if (e.getInventory().getTitle().equals(String.valueOf(Config.cor) + "Loja de Classes")) {
            ...
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§7Deshfire")) {
                ...
                if (money >= 150000) {
                    p.sendMessage(String.valueOf(Config.prefix) + "§7Voc\u00ea Acabou de Comprar o Kit " + Config.cor + "Deshfire");
                    Main.instance.getServer().dispatchCommand((CommandSender)Main.instance.getServer().getConsoleSender(), "pex user " + p.getName() + " add kit.Deshfire");
                    Status.removeMoney(p, 150000);
                    ScoreBoard.onScoreboard(p);
                    ScoreBoard.onScoreboard(p);
                    return;
                }
                p.sendMessage(String.valueOf(Config.prefix) + "§7Voc\u00ea precisa de 150000 de money para comprar esse kit.");
            }
                ...
                if (money >= 150000) {
                    p.sendMessage(String.valueOf(Config.prefix) + "§7Voc\u00ea Acabou de Comprar o Kit " + Config.cor + "Viking");
                    Main.instance.getServer().dispatchCommand((CommandSender)Main.instance.getServer().getConsoleSender(), "pex user " + p.getName() + " add kit.Viking");
                    Status.removeMoney(p, 150000);
                    ScoreBoard.onScoreboard(p);
                    return;
                }
                ...
                if (money >= 150000) {
                    p.sendMessage(String.valueOf(Config.prefix) + "§7Voc\u00ea Acabou de Comprar o Kit " + Config.cor + "Gladiator");
                    Main.instance.getServer().dispatchCommand((CommandSender)Main.instance.getServer().getConsoleSender(), "pex user " + p.getName() + " add kit.Gladiator");
                    Status.removeMoney(p, 150000);
                    ScoreBoard.onScoreboard(p);
                    return;
                }
                ...
                if (money >= 150000) {
                    p.sendMessage(String.valueOf(Config.prefix) + "§7Voc\u00ea Acabou de Comprar o Kit " + Config.cor + "Stomper");
                    Main.instance.getServer().dispatchCommand((CommandSender)Main.instance.getServer().getConsoleSender(), "pex user " + p.getName() + " add kit.Stomper");
                    Status.removeMoney(p, 150000);
                    ScoreBoard.onScoreboard(p);
                    return;
                }
