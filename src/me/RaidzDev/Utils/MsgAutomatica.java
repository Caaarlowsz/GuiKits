								...
								(Runnable) new Runnable() {
									...
									public void run() {
										...
										for (int length = (onlinePlayers = Bukkit.getOnlinePlayers()).length,
												i = 0; i < length; ++i) {
											final Player s = onlinePlayers[i];
											s.sendMessage(Main.instance.configuracoes.getString("Mensagem2")
													.replace("&", "§"));
											Main.instance.save();
											Main.instance.save1();
											Main.instance.save2();
								...
								(Runnable) new Runnable() {
									...
									public void run() {
										...
										for (int length = (onlinePlayers = Bukkit.getOnlinePlayers()).length,
												i = 0; i < length; ++i) {
											final Player s = onlinePlayers[i];
											s.sendMessage(Main.instance.configuracoes.getString("Mensagem3")
													.replace("&", "§"));
											Main.instance.save();
											Main.instance.save1();
											Main.instance.save2();
								...
								(Runnable) new Runnable() {
									...
									public void run() {
										...
										for (int length = (onlinePlayers = Bukkit.getOnlinePlayers()).length,
												i = 0; i < length; ++i) {
											final Player s = onlinePlayers[i];
											s.sendMessage(Main.instance.configuracoes.getString("Mensagem4")
													.replace("&", "§"));
											Main.instance.save();
											Main.instance.save1();
											Main.instance.save2();
								...
								(Runnable) new Runnable() {
									...
									public void run() {
										...
										for (int length = (onlinePlayers = Bukkit.getOnlinePlayers()).length,
												i = 0; i < length; ++i) {
											final Player s = onlinePlayers[i];
											s.sendMessage(Main.instance.configuracoes.getString("Mensagem5")
													.replace("&", "§"));
											Main.instance.save();
											Main.instance.save1();
											Main.instance.save2();
