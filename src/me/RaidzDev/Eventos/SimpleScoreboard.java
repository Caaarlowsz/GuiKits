...
public class SimpleScoreboard
{
    ...
    private Map.Entry<Team, String> createTeam(final String text) {
        ...
        final Iterator iterator = Splitter.fixedLength(16).split((CharSequence)text).iterator();
    ...
    public void build() {
        ...
        for (final Map.Entry text : this.scores.entrySet()) {
            final Map.Entry team = this.createTeam(text.getKey());
