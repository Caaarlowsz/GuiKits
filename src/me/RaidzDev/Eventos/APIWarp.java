        ...
        if (cmd.getName().equalsIgnoreCase("setrdm")) {
            ...
            if (!cmd.getName().equalsIgnoreCase("setKnock")) {
                if (cmd.getName().equalsIgnoreCase("rdm")) {
                    p.sendMessage(String.valueOf(Config.prefix) + " §7Voc\u00ea ser\u00e1 teletransportado em 5 segundos");
                    ...
                    Bukkit.getScheduler().scheduleSyncDelayedTask((Plugin)Main.getInstance(), (Runnable)new Runnable() {
                        ...
                        public void run() {
                            if (APIWarp.warping.contains(p)) {
                                ...
                                final World w = Bukkit.getServer().getWorld(Main.getInstance().warps.getString("RdmWorld"));
                    ...
                    Bukkit.getScheduler().scheduleSyncDelayedTask((Plugin)Main.instance, (Runnable)new Runnable() {
                        ...
                        public void run() {
                            if (APIWarp.warping.contains(p)) {
                                ...
                                ScoreBoard.onScoreboard(p);
                                KitAPI.setKit(p, "Warps");
                                final World w = Bukkit.getServer().getWorld(Main.instance.warps.getString("KnockWorld"));
